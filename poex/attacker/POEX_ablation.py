...
from ..selector.ReferenceLossSelector import ReferenceLossSelector
...
from ..metrics.Evaluator_PrefixExactMatch import EvaluatorPrefixExactMatch
...
class POEX_ablation(AttackerBase):
    def __init__(
        self,
        ...
        # self.mutator = MutationTokenGradient(attack_model, num_turb_sample=num_turb_sample, is_universal=is_universal)
