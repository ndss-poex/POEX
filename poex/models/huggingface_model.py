...
class HuggingfaceModel(WhiteBoxModelBase):
    ...
    def create_format_str(self):
        if self.mode == 'target' or self.mode == 'attack':
            ...
            with open('/home/dev/shine/POEX/prompts/safe_system_prompt.txt', 'r') as f:
                system_message = f.read()
            self.set_system_message(system_message)
            # 从txt导入系统提示
            with open('/home/dev/shine/POEX/prompts/planner_prompt.txt', 'r') as f:
                user1 = f.read()
            ...
            self.conversation.messages = []
            with open('/home/dev/shine/POEX//prompts/unaligned_system_prompt.txt', 'r') as f:
                system_message = f.read()
            self.set_system_message(system_message)
            # 从txt导入系统提示
            with open('/home/dev/shine/POEX//prompts/planner_prompt.txt', 'r') as f:
