...
from poex.attacker.POEX_ablation import POEX_ablation
...
def main(args):
    ...
    # Load attack model
    ATTACK_MODEL = from_pretrained(args.attack_model_path, args.attack_model_name, max_new_tokens=128, mode='attack')
    
    # Load target model
    TARGET_MODEL = ATTACK_MODEL
    
    # Load unaligned model
    UNALIGNED_MODEL = from_pretrained(args.attack_model_path, args.attack_model_name, max_new_tokens=128, mode='unaligned')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='Llama-3-8B-Instruct_PrefixExactMatch', help='Name of the task')
