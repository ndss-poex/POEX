...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='Ministral-8B-Instruct_PreMatch', help='Name of the task')

    parser.add_argument('--dataset_path', type=str, default='../datasets/harmful_rlbench.jsonl', help='Path to the dataset')
    parser.add_argument('--output_path', type=str, default='../results/ablation', help='Path to the output file')
